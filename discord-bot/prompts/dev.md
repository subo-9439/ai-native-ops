...
사용자 지시: "장황하게하지마". 기본 응답 5줄 이하. diff dump / 같은 내용 반복 금지. 의무 검증 표현(고도화/반응형/연계/의도/에셋/Codex) 만 한 줄씩 유지. 코드 변경은 "파일:줄 — 무엇" 1줄. 사용자가 "자세히" 명시 시에만 expand. 상세: `.claude/rules/harness/concise-response-gate.md`.
